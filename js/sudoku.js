...
const EXTREME_SUDOKU_PUZZLES = [
    ...
    // 题目3：17提示数独（国际数独题库收录）
    { 
        puzzle: "005030080009000040070060002000000000000000000000000000010090060020000500080020900", 
        solution: "145937862869251743372864195987146235231578496564329871718495362426783519683621957" 
    },
    // 题目4：Gordon Royle #1
    ...
    { puzzle: "000000000000003085001020000000507000004000100090000000500000073002010000000040009" },
    // 题目6：Gordon Royle #3
    { puzzle: "000000000000030000006000008000010004000005700000000003001000020000004000070000000" },
    // 题目7：Gordon Royle #4
    { puzzle: "000000001000200030000004000000050600070000300000000000000000080000000000000000000" },
    // 题目8：Gordon Royle #5
    { puzzle: "000000010000000200030000000000400000005000600000070000000000008000000900000000000" },
    // 题目9：Gordon Royle #6
    { puzzle: "000000012000000003000000004000000005006007000000000000000000000000000000000000000" },
    // 题目10：17提示 (额外)
    { puzzle: "100000000002000000000300000000040000050060000700000000000008000000009000000000000" }
];
